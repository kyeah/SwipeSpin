...
import com.kyeah.android.light.*;
...
public class Matrix {
  ...
  */
  ...
  public double[] calculateVertexNormal( int index ){
	...
	for(int i=0; i < m[0].length - 2; i = i+3 ){
		...
		if( j != index &&
			...
			/* Adds polygon normal to the average if it makes a
  ...
  public double[] calculateProjection( int i, Light light, int interp ){
  ...
  public double calculateDiffuse( int i, Light light, int interp ){
  ...
  public double calculateSpecular( int i, Light light, double[] view, int interp ){
  ...
  */
  ...
  public void makeScaleX(double x){
	  ident();
	  m[0][0] = x;
  }
  
  public void makeScaleY(double y){
	  ident();
	  m[1][1] = y;
  }
  
  public void makeScaleZ(double z){
	  ident();
	  m[2][2] = z;
  }
  /*=========== MakeRotX ================
  ...
  */
  ...
  /**
   * 
   * @returns the z-coordinate of the origin point.
   */
  public double getZ(){
	  return m[2][3];
  }
